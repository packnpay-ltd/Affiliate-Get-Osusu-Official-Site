    ...
    <div id="main-wrapper" class="flex">
        ...
        <div class="w-full overflow-hidden">
            ...
            <main class="h-full overflow-y-auto max-w-full pt-4 px-6">
                <h4 class="text-gray-600 text-lg font-semibold mb-6">Create New Product</h4>
                    ...
                    <form action="<?php echo e(route('products.store')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-2">
                                ...
                                <textarea name="short_description" class="mt-1 p-2 w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"></textarea>
                            </div>
                            <div class="col-span-2">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Cover Product Image</label>
                            ...
                            <?php for($i = 2; $i <= 5; $i++): ?>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Optional Image <?php echo e($i - 1); ?></label>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Affiliate-Get-Osusu-Official-Site\resources\views\admin\products\create.blade.php ENDPATH**/ ?>