(function ($) {
    ...
    $(document).ready(function () {
        ...
        /* tabs-Categories-Tailwindcss */
        $("#myCategoriesTab li:first-child").addClass("active");
        $(".tab-categories-pane").hide();
        $(".tab-categories-pane:first").show();
        $("#myCategoriesTab li").click(function () {
            $("#myCategoriesTab li").removeClass("active");
            $(this).addClass("active");
            $(".tab-categories-pane").hide();
            var activeTab = $(this).find("a").attr("href");
            $(activeTab).fadeIn();
        ...
        /* tabs-delivery-Tailwindcss */
        $("#mydeliveryTab li:first-child").addClass("active");
        $(".tab-delivery-pane").hide();
        $(".tab-delivery-pane:first").show();
        $("#mydeliveryTab li").click(function () {
            $("#mydeliveryTab li").removeClass("active");
            $(this).addClass("active");
            $(".tab-delivery-pane").hide();
            var activeTab = $(this).find("a").attr("href");
            $(activeTab).fadeIn();
    ...
    /*----------- modal ----------------*/
    $(".cr-modal-toggle").on("click", function () {
        $(".cr-modal-overlay").fadeIn();
        $(".cr-modal").fadeIn();
        $("body").addClass("cr-overflow-hidden")
        $(".cr-modal-dialog").addClass("cr-fadeOutUp");
        $(".cr-modal-dialog").removeClass("cr-fadeInDown");
    });

    $(".cr-close-modal, .cr-modal-overlay").on("click", function () {
        $(".cr-modal-overlay").fadeOut();
        $(".cr-modal").fadeOut();
        $("body").removeClass("cr-overflow-hidden")
        $(".cr-modal-dialog").removeClass("cr-fadeOutUp");
        $(".cr-modal-dialog").addClass("cr-fadeInDown");
    });
    ...
    /* Deal */
    function makeTimer() {
        var endTime = new Date("9 March 2025 9:56:00 GMT+01:00");
