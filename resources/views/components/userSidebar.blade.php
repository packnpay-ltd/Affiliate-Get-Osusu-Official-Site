  ...
  <div class="px-6 py-4">
    ...
    <button id="close-sidebar" class="absolute top-4 right-4 text-gray-500 hover:text-gray-700">
      <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
        ...
        <img src="{{ asset('images/logo.png') }}" alt="Logo-Dark" class="mb-6">
            <nav class="mt-6">
              ...
              <div class="mt-4">
                ...
                <a href="{{ route('affiliate.overview') }}" class="flex gap-2 block py-2.5 px-4 rounded-md hover:bg-purple-200 text-gray-600 font-medium">
                  <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  </svg>
                  Overview
                </a>
                <a href="{{ route('affiliate.referrals') }}" class="flex gap-2 block py-2.5 px-4 rounded-md hover:bg-purple-200 text-gray-600 font-medium">
                  <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                  </svg>
                  My Referrals
                </a>
                <a href="{{ route('affiliate.earnings') }}" class="flex gap-2 block py-2.5 px-4 rounded-md hover:bg-purple-200 text-gray-600 font-medium">
                  <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  Earnings
                </a>
                <a href="{{ route('affiliate.marketing') }}" class="flex gap-2 block py-2.5 px-4 rounded-md hover:bg-purple-200 text-gray-600 font-medium">
                  <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
