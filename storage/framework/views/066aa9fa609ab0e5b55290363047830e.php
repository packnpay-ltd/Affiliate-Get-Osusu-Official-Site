            ...
            <div class="flex flex-wrap w-full">
                <div class="w-full px-[12px]">
                    <div class="top-header py-[20px] flex flex-row gap-[20px] justify-between border-b-[1px] border-solid border-[#e9e9e9] relative z-[4] max-[575px]:py-[15px] max-[575px]:block">
                        <a href="<?php echo e(route('dashboard.marketplace')); ?> " class="cr-logo max-[575px]:mb-[15px] max-[575px]:flex max-[575px]:justify-center">
                            <img src="<?php echo e(asset('images/osusu_logo.svg')); ?>" alt="logo" class="logo block  lg:w-[13rem] md:w-[13rem] w-[7rem]">
                        </a>
                        ...
                        <div class="cr-right-bar flex items-center max-[991px]:hidden">
                            <ul class="navbar-nav m-auto relative z-[3]">
                                <li class="nav-item dropdown relative">
                                    <a href="<?php echo e(route('dashboard')); ?>" class="nav-link  cr-right-bar-item transition-all duration-[0.3s] ease-in-out flex items-center relative text-[14px] font-medium text-[#000] z-[1] relative py-[11px] pr-[30px] pl-[8px] max-[1199px]:py-[8px]" href="javascript:void(0)">
                            ...
                            <a href="<?php echo e(route('wallet.show')); ?>" class="cr-right-bar-item pr-[30px] transition-all duration-[0.3s] ease-in-out flex items-center">
                                ...
                                <span class="transition-all duration-[0.3s] ease-in-out font-Poppins text-[15px] leading-[15px] font-medium text-[#000]">
                                      ₦<?php echo e(number_format(Auth::user()->wallet_balance ?? 0, 2)); ?></span>
                            </a>
                            <?php
                                $cartCount = \App\Models\Cart::where('user_id', auth()->id())->sum('quantity');
                            ?>

                            <a href="<?php echo e(route('cart')); ?>" class="relative inline-flex items-center p-2 text-sm font-medium text-center text-white bg-purple-700 rounded-lg focus:ring-4 focus:outline-none focus:ring-blue-300">
                ...
                <div class="cr-menu-list w-full px-[12px] relative flex items-center flex-row justify-between">
                                ...
                                <div class="cr-cat-tab grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                        ...
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <li class="transition-all duration-[0.3s] ease-in-out py-[10px] px-[5px] bg-[#fff] border-[1px] border-solid border-[#e9e9e9] rounded-[5px] flex items-center cursor-pointer mb-[3px]">
                                                <a href="<?php echo e(url('/category/' . urlencode($category->category))); ?>" class="text-[13px] text-[#4b5966] tracking-[0] font-medium text-left capitalize">
                                                    <?php echo e($category->category); ?> (<?php echo e($category->products_count); ?>)
                                                </a>
                                            </li>
                                    </ul>
                    ...
                    <nav class="justify-between relative flex flex-wrap items-center max-[991px]:w-full max-[991px]:py-[10px]">
                       ...
                       <div class="cr-header-buttons max-[991px]:flex max-[991px]:items-center flex items-center md:hidden lg:hidden block mb-1">
                            <a href="<?php echo e(route('dashboard')); ?>" class="cr-right-bar-item transition-all duration-[0.3s] ease-in-out mr-[16px] max-[991px]:mr-[20px]">
                        ...
                        <div class="min-[992px]:flex min-[992px]:basis-auto grow-[1] items-center hidden" id="navbarSupportedContent">
                            <ul class="navbar-nav flex min-[992px]:flex-row items-center m-auto relative z-[3] min-[992px]:flex-row max-[1199px]:mr-[-5px] max-[991px]:m-[0]">
                                            ...
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li class="w-full mr-[0]">
                                                    <a class="dropdown-item transition-all duration-[0.3s] ease-in-out font-Poppins py-[7px] px-[20px] bg-[#fff] relative capitalize text-[13px] text-[#777] hover:text-[#64b496] whitespace-nowrap tracking-[0.03rem] block w-full"
                                                       href="<?php echo e(route('category.products', ['category' => $category->slug])); ?>">
                                ...
                                <li class="nav-item dropdown relative mr-[25px] max-[1399px]:mr-[20px] max-[1199px]:mr-[30px]">
                                    <a href="<?php echo e(route('all.products')); ?>" class="nav-link  font-Poppins text-[14px] font-medium block text-[#000] z-[1] flex items-center relative py-[11px] px-[8px] max-[1199px]:py-[8px] max-[1199px]:px-[0]">
                                        Products
                                    </a>
                                </li>
                                <li class="nav-item dropdown relative mr-[25px] max-[1399px]:mr-[20px] max-[1199px]:mr-[30px]">
                                    ...
                                    <ul class="dropdown-menu transition-all duration-[0.3s] ease-in-out py-[8px] min-w-[160px] mt-[35px] absolute text-left opacity-0 invisible left-auto bg-[#fff] rounded-[5px] block z-[9] border-[1px] border-solid border-[#e9e9e9]">
                                        ...
                                        <li class="w-full mr-[0]">
                                            <a class="dropdown-item transition-all duration-[0.3s] ease-in-out font-Poppins py-[7px] px-[20px] bg-[#fff] relative capitalize text-[13px] text-[#777] hover:text-[#64b496] whitespace-nowrap tracking-[0.03rem] block w-full" href="<?php echo e(route('contact.show')); ?>">Contact Us</a>
                                        </li>
                                        <li class="w-full mr-[0]">
                                            <a class="dropdown-item transition-all duration-[0.3s] ease-in-out font-Poppins py-[7px] px-[20px] bg-[#fff] relative capitalize text-[13px] text-[#777] hover:text-[#64b496] whitespace-nowrap tracking-[0.03rem] block w-full" href="<?php echo e(route('terms')); ?>">Terms & Condition</a>
                                        </li>
                                        <li class="w-full mr-[0]">
                                            <a class="dropdown-item transition-all duration-[0.3s] ease-in-out font-Poppins py-[7px] px-[20px] bg-[#fff] relative capitalize text-[13px] text-[#777] hover:text-[#64b496] whitespace-nowrap tracking-[0.03rem] block w-full" href="<?php echo e(route('privacy.policy')); ?>">Policy</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item dropdown relative mr-[25px] max-[1399px]:mr-[20px] max-[1199px]:mr-[30px]">
        ...
        <div class="cr-menu-inner">
            <div class="cr-menu-content">
                <ul>
                        ...
                        <a href="javascript:void(0)" class="dropdown-list py-[12px] block capitalize text-[15px] font-medium text-[#444] border-b-[1px] border-solid border-[#e9e9e9]">Category</a>
                                ...
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li class="relative leading-[28px]">
                                                    <a class="transition-all duration-[0.3s] ease-in-out pl-[20px] opacity-[0.8] text-[14px] py-[12px] block capitalize font-medium text-[#444] border-b-[1px] border-solid border-[#e9e9e9]" href="<?php echo e(route('category.products', ['category' => $category->slug])); ?>">
                                                        <?php echo e($category->name); ?>
                    ...
                    <li class="dropdown drop-list relative leading-[28px]">
                        <a href="<?php echo e(route('all.products')); ?>" class="py-[12px] block capitalize text-[15px] font-medium text-[#444] border-b-[1px] border-solid border-[#e9e9e9]">Products</a>
                    ...
                    <li class="dropdown drop-list relative leading-[28px]">
                        ...
                        <ul class="sub-menu w-full mb-[0] p-[0] hidden min-w-auto opacity-[1]">
                            ...
                            <li class="relative leading-[28px]">
                                <a href="<?php echo e(route('contact.show')); ?>" class="transition-all duration-[0.3s] ease-in-out pl-[20px] opacity-[0.8] text-[14px] py-[12px] block capitalize font-medium text-[#444] border-b-[1px] border-solid border-[#e9e9e9]">Contact Us</a>
                            </li>
                            <li class="relative leading-[28px]">
                                <a href="<?php echo e(route('terms')); ?>" class="transition-all duration-[0.3s] ease-in-out pl-[20px] opacity-[0.8] text-[14px] py-[12px] block capitalize font-medium text-[#444] border-b-[1px] border-solid border-[#e9e9e9]">Terms & Condition</a>
                            </li>
                            <li class="relative leading-[28px]">
                                <a href="<?php echo e(route('privacy.policy')); ?>" class="transition-all duration-[0.3s] ease-in-out pl-[20px] opacity-[0.8] text-[14px] py-[12px] block capitalize font-medium text-[#444] border-b-[1px] border-solid border-[#e9e9e9]">Policy</a>
                            </li>
...
</script><?php /**PATH C:\xampp\htdocs\Affiliate-Get-Osusu-Official-Site\resources\views\components\header.blade.php ENDPATH**/ ?>