    ...
    <div class="container mx-auto px-4 py-8">
        <div class="bg-white shadow-md rounded-lg p-6">
            ...
            <div class="bg-gray-50 p-4 rounded-lg mb-6">
                <p class="text-2xl font-bold text-green-600">₦<?php echo e(number_format(Auth::user()->wallet_balance ?? 0, 2)); ?></p>
            </div>
            <form action="<?php echo e(route('wallet.deposit')); ?>" method="POST" class="space-y-4">
                <?php echo csrf_field(); ?>
                <div>
            ...
            <table class="min-w-full table-auto">
                ...
                <tbody>
                    <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="px-4 py-2"><?php echo e(ucfirst($transaction->type)); ?></td>
                            <td class="px-4 py-2">₦<?php echo e($transaction->amount); ?></td>
                            <td class="px-4 py-2"><?php echo e(ucfirst($transaction->status)); ?></td>
                            <td class="px-4 py-2"><?php echo e($transaction->transaction_reference); ?></td>
                            <td class="px-4 py-2"><?php echo e($transaction->created_at->format('Y-m-d H:i:s')); ?></td>
                        </tr>
...
<?php /**PATH C:\xampp\htdocs\Affiliate-Get-Osusu-Official-Site\resources\views\wallet\show.blade.php ENDPATH**/ ?>