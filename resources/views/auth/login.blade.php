        ...
        <div class="w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div class="p-8">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-4">
                        <x-input-label for="login" :value="__('Email or Phone Number')" class="text-gray-700 font-semibold" />
                        <x-text-input
                            id="login"
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="{{ route('password.request') }}" class="text-sm text-purple-600 hover:text-purple-700 font-semibold">Reset Password</a>
                    </div>
                ...
                <div class="mt-8 text-center">
                    ...
                    <a href="{{ route('register') }}" class="text-purple-600 hover:text-purple-700 font-semibold">Join our Affiliate Program</a>
                </div>
            </div>
        </div>
    </div>
