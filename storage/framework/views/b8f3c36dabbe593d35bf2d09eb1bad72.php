<aside id="application-sidebar-brand"
                ...
                <div class="p-5">
                    <a href="/" class="text-nowrap">
                        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo-Dark" class="w-full max-w-[150px]" />
                    </a>
                </div>
                    ...
                    <div class="px-6 mt-8">
                        <nav class="w-full flex flex-col sidebar-nav">
                            <ul id="sidebarnav" class="text-gray-600 text-sm">
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link gap-3 py-2 px-3 rounded-md w-full flex items-center hover:text-white hover:bg-blue-500"
                                        href="<?php echo e(route('admin.blog.all')); ?>">
                                        <i class="ti ti-alert-circle text-xl"></i>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link gap-3 py-2 px-3 rounded-md w-full flex items-center hover:text-white hover:bg-blue-500"
                                        href="<?php echo e(route('payment.transaction')); ?>">
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link gap-3 py-2 px-3 rounded-md w-full flex items-center hover:text-white hover:bg-blue-500"
                                        href="<?php echo e(route('support_tickets.index')); ?>">
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link gap-3 py-2 px-3 rounded-md w-full flex items-center hover:text-white hover:bg-blue-500"
                                        href="<?php echo e(route('admin.waitlist')); ?>">
...
<?php /**PATH C:\xampp\htdocs\Affiliate-Get-Osusu-Official-Site\resources\views\components\adminSideBar.blade.php ENDPATH**/ ?>